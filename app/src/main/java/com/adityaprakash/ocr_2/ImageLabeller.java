...
public class ImageLabeller extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myToolbar.setTitle("Label in Photo");
        ...
        if (requestCode == GALLERY) {
            if (data != null) {
                ...
                try {
                   ...
                   // Toast.makeText(ImageLabeller.this, "Image Saved!", Toast.LENGTH_SHORT).show();
                    imageview.setImageBitmap(bitmap);
                    textView.setText("");
                    firebaseLabeller(bitmap);


                } catch (IOException e) {
                    e.printStackTrace();
                    Toast.makeText(ImageLabeller.this, "Failed!", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void firebaseLabeller(Bitmap bitmap) {
...
//Display the label and confidence score in our TextView//
                    ...
                    textView.append(label.getLabel() + "\n");
...
//Register an OnFailureListener//
    ...
    private void scaleImage(ImageView view) {
        ...
        BitmapDrawable result = new BitmapDrawable(ImageLabeller.this.getResources(), scaledBitmap);
