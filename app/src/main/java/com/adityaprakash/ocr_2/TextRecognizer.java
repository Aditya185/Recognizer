...
public class TextRecognizer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myToolbar.setTitle("Text in Photo");
...
//                    String path = saveImage(bitmap);
                  //  Toast.makeText(TextRecognizer.this, "Image Saved!", Toast.LENGTH_SHORT).show();
                    imageview.setImageBitmap(bitmap);

                    firebaseRecognizer(bitmap);


                } catch (IOException e) {
                    e.printStackTrace();
                    Toast.makeText(TextRecognizer.this, "Failed!", Toast.LENGTH_SHORT).show();
                }
            }
...
//            String path1 = saveImage(thumbnail);
    ...
    private void firebaseRecognizer(Bitmap bitmap) {
    ...
    private void scaleImage(ImageView view) {
        ...
        BitmapDrawable result = new BitmapDrawable(TextRecognizer.this.getResources(), scaledBitmap);
